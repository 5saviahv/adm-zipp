...
describe('headers', () => {
    ...
    describe('main-header', () => {
        ...
        // empty zip file
        const empty = Buffer.from([0x50,0x4B,0x05,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]);
        const readBuf = Buffer.from([0x50,0x4B,0x05,0x06,0x00,0x00,0x00,0x00,0xca,0xc0,0xce,0xfa,0xed,0x0b,0x00,0x00,0xee,0xff,0xc0,0x00,0x00,0x00]);
    ...
    describe('entry-header', () => {
        ...
        const readBuf = Buffer.from([
            0x50,0x4B,0x01,0x02,0x14,0x00,0x14,0x00,0x00,0x08,0x08,0x00,0x45,0x61,0x81,0x02,
            0xef,0xbe,0xad,0xde,0x00,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        describe('data-header', () => {
            ...
            const dataheader = Buffer.from([
                0x50,0x4B,0x03,0x04,0x14,0x00,0x00,0x08,0x08,0x00,0x45,0x61,0x81,0x02,0xef,0xbe,0xad,0xde,0x00,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00
            ]);
